...
IMAGE_CMD_hdfastboot8gb () {
    ...
    dd if=/dev/zero of=${IMGDEPLOYDIR}/${IMAGE_LINK}.ext4 seek=${IMAGE_ROOTFS_SIZE} count=$COUNT bs=1024
    mkfs.ext4 -F -i 4096 ${IMGDEPLOYDIR}/${IMAGE_LINK}.ext4 -d ${WORKDIR}/rootfs
    ...
    echo "imageurl https://tuxbox-images.de" > ${WORKDIR}/bootmenu.conf
    ...
    ext2simg -zv ${IMGDEPLOYDIR}/${IMAGE_LINK}.ext4 ${IMGDEPLOYDIR}/${IMAGE_NAME}${IMAGE_NAME_SUFFIX}.hdfastboot8gb.gz
}
